...
public class RainServiceImpl implements RainService{
	 ...
	 */
	@Override
	public List<Toudi> getToudiList(Integer id) {
		// TODO Auto-generated method stub
		return toudidao.get_ToudiList(id);
	}
	@Override
	...
	@Override
	public void insert_Toudi(Toudi toudi) {
		// TODO Auto-generated method stub
		toudidao.insert_Toudi(toudi);
	}
}
